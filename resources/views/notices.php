...
<div class="container">
	...
	<div id="notifications" class="w-50 p-3 h-75 d-inline-block row" style="overflow:auto;">
		...
		<div id="notif_2" class="alert alert-info alert-dismissible row">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			Vous avez ete invite a rejoindre l'evenement <strong>&EVENT&</strong>!
		</div>

		<div id="notif_3" class="alert alert-success alert-dismissible row">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			Votre demande d'ajout a l'evenement <strong>&EVENT&</strong> a ete acceptee.
		</div>

		<div id="notif_4" class="alert alert-warning alert-dismissible row">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			Votre demande d'ajout a l'evenement <strong>&EVENT&</strong> a ete refusee.
		</div>

		<div id="notif_4" class="alert alert-danger alert-dismissible row">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
